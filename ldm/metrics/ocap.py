...
class CraftOCap:
    ...
    def compute(self, *, images=None, captions=None, progress_bar=True, **chrf_kwargs):
        """
        Args:
        ...
        return self._compute_score_given_ocr_features(ocr_features, captions, **chrf_kwargs)
    ...
    def _compute_score_given_ocr_features(self, ocr_features, captions):
        ...
        score = self.chrf.compute(predictions=ocr_texts, references=captions, beta=0, char_order=4, word_order=0)
        return score
