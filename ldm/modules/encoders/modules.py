...
class FrozenCLIPEmbedder(AbstractEncoder):
    ...
    def __init__(self, version="openai/clip-vit-large-patch14", device=None, max_length=77):
        ...
        self.device = "cuda" if torch.cuda.is_available() else "cpu"  # TODO: set device explicitly in the training script
        self.max_length = max_length
        self.freeze()
    ...
    def forward(self, text, pad_to_max_length=True):
        # pad_to_max_length here is just for compatibility with other embedders
        batch_encoding = self.tokenizer(text, truncation=True, max_length=self.max_length, return_length=True,
                                        return_overflowing_tokens=False, padding="max_length", return_tensors="pt")
